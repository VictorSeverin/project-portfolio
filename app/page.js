      ...
      <div className="flex flex-col md:flex-row py-20 md:py-32 justify-between w-full max-w-7xl  h-full ">
        <div className=" flex flex-col gap-20 h-full mx-5">
          <div className="max-w-xl text-wrap flex flex-col justify-start items-start ">
            ...
            <br />
            <span className="text-xl md:text-3xl">Full Stack Developer</span>
            <br />
            <span className="text-lg md:text-2xl italic">Sacramento,CA</span>
          </div>
          <div>
            ...
            <ul className="list-disc pl-7 text-lg">
              ...
              <li className="">
                ...
                <span className="italic">IRT Web&Mobile - Sacramento,CA</span>
              </li>
              <li className="">
                Web Development and IT Staff at{" "}
                <span className="italic">
                  Emanuel Calvary Chapel - Sacramento,CA
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex gap-5">
            <Link href="https://github.com/VictorSeverin">
              <svg
            ...
            <Link href="https://www.linkedin.com/in/victor-severin-1a2589233/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                className="w-10 h-10 "
            ...
            <Link href="mailto:victor.severin7@gmail.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                className="w-10 h-10 "
